...
export interface TunnelPortV2 {
     ...
     * connection to the port {@link TunnelPortV2.protocol}, so it is possible to
     * configure separate defaults for distinct protocols like {@link TunnelProtocol.http}
     * and {@link TunnelProtocol.ssh}.
     */
    isDefault?: boolean;
    /**
...
//# sourceMappingURL=tunnelPortV2.d.ts.map